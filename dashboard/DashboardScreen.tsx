...
import { Button, Card, Paragraph, Title, Text, IconButton, ActivityIndicator } from "react-native-paper";
              ...
              <Card.Content>
                ...
                {loading ? (
                  ...
                  <>
                    ...
                    <Paragraph>
                      Experts say you should aim for 2.5 tons of CO2 per year to prevent catastrophic consequences due
                      to climate warming. In the last 12 months you emitted{" "}
